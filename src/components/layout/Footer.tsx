                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                            ...
                            <div>
                                <p>
                                    ...
                                    <a
                                        href="#"
                                        className="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl dark:text-gray-100"
                                    >
                                        0123456789
                                    </a>
                                </p>

                                <ul className="mt-8 space-y-1 text-sm text-gray-700 dark:text-gray-300">
